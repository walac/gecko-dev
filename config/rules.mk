...
ifeq (,$(CROSS_COMPILE))
clang_wrapper=$(topsrcdir)/clang-linker-wrapper.sh
else
clang_wrapper=$(topsrcdir)/clang-linker-wrapper-cross.sh
endif
...
env $(environment_cleaner) $(rust_unlock_unstable) $(rustflags_override) \
	CARGO_TARGET_X86_64_APPLE_DARWIN_LINKER="$(clang_wrapper)" \
	CC_x86_64_apple_darwin="$(clang_wrapper)" \
